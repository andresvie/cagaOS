...
boolean is_page_directory_present(pd_entry_t e);

boolean is_page_directory_writable(pd_entry_t e);

physical_address get_page_directory_frame_physical_address(pd_entry_t *e);

void set_page_directory_frame_physical_address(pd_entry_t e);
...
boolean is_page_writable(pt_entry_t e);

boolean is_page_present(pt_entry_t e);

boolean is_page_dirty(pt_entry_t e);
