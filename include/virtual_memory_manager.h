...
#define KERNEL_NUMBER_OF_PAGES_FOR_256MB    0x2000
...
typedef pd_directory_t page_directory;
typedef pt_entry_t page_table;
...
extern void enable_page(physical_address page_dir_address);
